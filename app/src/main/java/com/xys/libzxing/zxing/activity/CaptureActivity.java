...
public final class CaptureActivity extends BaseActivity implements SurfaceHolder.Callback {
    public static final int ACTION_QR = 0xFF;
    ...
    public Handler getZxingHandler() {
        return handler;
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        topNavigationBar.setLeftClick(new View.OnClickListener() {
            @Override
    ...
    private void displayFrameworkBugMessageAndExit() {
        ...
        dialog.setTitleText(R.string.camera_wrong);
        dialog.setOnAlterClickListener(new OnAlterClickListener() {
            @Override
    ...
    private void initCrop() {
        ...
        int cropTop = location[1]- topNavigationBar.getHeight();
