...
/**
 * Created by SensYang on 2017/04/28 9:43
 */

public class GroupStateCallBack implements EMGroupChangeListener {
    /**
     * \~chinese
     * 当前用户收到加入群组邀请
     *
