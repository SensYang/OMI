...
/**
 * Created by SensYang on 2016/8/19 0019.
 */
public class IDCard {
    ...
    private static ArrayMap<String, Integer> dateMap;
    private static ArrayMap<String, String> areaCodeMap;
    private static IDCard instance;

    public static IDCard getInstance() {
        if (instance == null) instance = new IDCard();
        return instance;
    }

    static {
        dateMap = new ArrayMap<>();
        dateMap.put("01", 31);
        dateMap.put("02", null);
        dateMap.put("03", 31);
        dateMap.put("04", 30);
